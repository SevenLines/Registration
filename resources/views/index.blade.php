...
@section("body_content")
    ...
    <div class="location-info">
        <hr>
        <h3>Мы находися по адресу: <strong>Метро Патризанская. Измайловское шоссе д. 71 корп. 4г-д</strong></h3>

        <div class="row" >
            <div class="col-md-5 col-sm-12 col-xs-12 map">
            ...
            <div class="col-md-7 col-sm-12 col-xs-12 image">
