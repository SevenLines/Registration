...
@section("content")
    ...
    <div class="container">
        ...
        <div class="documents-list">
            ...
            <div class="document-item col-md-3 col-sm-4 col-xs-6">
                <div class="inner">
                    <img src={{ asset("images/types/patent.jpg") }} alt="">
                    <div class="description">ПАТЕНТ</div>
                </div>
            </div>
            <div class="document-item col-md-3 col-sm-4 col-xs-6">
                <div class="inner">
                    <img src={{ asset("images/types/health-insurance.jpg") }} alt="">
                    <div class="description">Медицинская страховка</div>
                </div>
            </div>
            <div class="document-item col-md-3 col-sm-4 col-xs-6">
                <div class="inner">
                    <img src={{ asset("images/types/allowance_to_work.jpg") }} alt="">
                    <div class="description">Разрешение на работу</div>
                </div>
            </div>
            <div class="document-item col-md-3 col-sm-4 col-xs-6">
                <div class="inner">
                    <img src={{ asset("images/types/in_out.jpg") }} alt="">
                    <div class="description">Въезд/выезд</div>
                </div>
            </div>
            <div class="document-item col-md-3 col-sm-4 col-xs-6">
                <div class="inner">
                    <img src={{ asset("images/types/rvp1.jpg") }} alt="">
                    <div class="description">Рвп</div>
                </div>
            </div>
            <div class="document-item col-md-3 col-sm-4 col-xs-6">
                <div class="inner">
                    <img src={{ asset("images/types/vnj.jpg") }} alt="">
                    <div class="description">Внж</div>
                </div>
            </div>
            <div class="document-item col-md-3 col-sm-4 col-xs-6">
                <div class="inner">
                    <img src={{ asset("images/types/grazhdanstvo.jpg") }} alt="">
                    <div class="description">Гражданство</div>
                </div>
            </div>
            <div class="document-item col-md-3 col-sm-4 col-xs-6">
                <div class="inner">
                    <img src={{ asset("images/types/med_commission.jpg") }} alt="">
                    <div class="description">МЕДКОМИССИЯ</div>
                </div>
            </div>
            <div class="document-item col-md-3 col-sm-4 col-xs-6">
                <div class="inner">
                    <img src={{ asset("images/types/zagran_passport.jpg") }} alt="">
                    <div class="description">загранпаспорт</div>
                </div>
            </div>
            <div class="document-item col-md-3 col-sm-4 col-xs-6">
                <div class="inner">
                    <img src={{ asset("images/types/visa.jpg") }} alt="">
                    <div class="description">Виза</div>
                </div>
            </div>
            <div class="document-item col-md-3 col-sm-4 col-xs-6">
                <div class="inner">
                    <img src={{ asset("images/types/priglashenie.jpg") }} alt="">
                    <div class="description">Приглашение</div>
                </div>
            </div>
            <div class="document-item col-md-3 col-sm-4 col-xs-6">
                <div class="inner">
                    <img src={{ asset("images/types/inn.jpg") }} alt="">
                    <div class="description">Получение Инн</div>
                </div>
            </div>
            <div class="document-item col-md-3 col-sm-4 col-xs-6">
                <div class="inner">
                    <img src={{ asset("images/types/fms.jpg") }} alt="">
